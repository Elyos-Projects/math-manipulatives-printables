...
> Auto-generated by Elyos task-decomposition agent · 2026-06-29 · 31 new task JSONs + 1 seed = 32 total

| File | Title | Type | Milestone | Priority | verifiedNeed |
|---|---|---|---|---|---|
| [math-manip-style-001.json](tasks/math-manip-style-001.json) | Author print & accessibility style guide v1 | writing | M0 | high | true |
| [math-manip-spec-001.json](tasks/math-manip-spec-001.json) | Define manipulative-spec schema + provenance/verification record | data | M0 | high | true |
| [math-manip-research-001.json](tasks/math-manip-research-001.json) | Open-asset license clearance (fonts + palettes) | research | M0 | high | true |
| [math-manip-research-002.json](tasks/math-manip-research-002.json) | Secure >=1 distribution channel (OER repo / teacher network / NGO) | research | M0 | high | true |
| [math-manip-design-001.json](tasks/math-manip-design-001.json) | Reference design + dimensional spec: fraction tiles (halves-twelfths) | design-spec | M0 | high | true |
| [math-manip-data-001.json](tasks/math-manip-data-001.json) | Generate + dimensionally verify cold-start fraction-tile set (A4+Letter, colour+grayscale) | data | M0 | high | false |
| [math-manip-writing-001.json](tasks/math-manip-writing-001.json) | Print-and-use instructions + recommended print settings | writing | M0 | medium | false |
| [math-manip-pr-001.json](tasks/math-manip-pr-001.json) | Distribute cold-start set via secured channel + establish baseline tracking | maintenance | M0 | high | false |
| [math-manip-code-001.json](tasks/math-manip-code-001.json) | Build parametric generator engine (spec to SVG to print-ready PDF) | code | M1 | high | true |
| [math-manip-code-002.json](tasks/math-manip-code-002.json) | Automated dimensional + relationship verification harness (CI gate) | code | M1 | high | true |
| [math-manip-code-003.json](tasks/math-manip-code-003.json) | Counters generator (two-colour + plain) | code | M1 | high | true |
| [math-manip-code-004.json](tasks/math-manip-code-004.json) | Number-line generator (integer/fraction/decimal/blank; ranges + steps) | code | M1 | high | true |
| [math-manip-code-005.json](tasks/math-manip-code-005.json) | Base-ten blocks generator (unit/rod/flat + thousand-cube net) | code | M1 | high | true |
| [math-manip-design-002.json](tasks/math-manip-design-002.json) | Colour-blind-safe palette + grayscale/ink-saver design system | design-spec | M1 | medium | true |
| [math-manip-data-002.json](tasks/math-manip-data-002.json) | Generate + verify full core set (4 families, both paper sizes, colour+grayscale) | data | M1 | high | false |
| [math-manip-code-006.json](tasks/math-manip-code-006.json) | Large-print + high-contrast variants of all four core families | code | M2 | medium | true |
| [math-manip-research-003.json](tasks/math-manip-research-003.json) | Accessibility audit (contrast ratios + colour-blind simulation) across the set | research | M2 | medium | false |
| [math-manip-research-004.json](tasks/math-manip-research-004.json) | Beneficiary validation: educator/family uses printed sets | research | M2 | medium | false |
| [math-manip-writing-002.json](tasks/math-manip-writing-002.json) | Curriculum-standards mapping for the four families | writing | M2 | medium | true |
| [math-manip-data-003.json](tasks/math-manip-data-003.json) | Expand denominations/ranges; publish expanded verified set | data | M2 | medium | false |
| [math-manip-code-007.json](tasks/math-manip-code-007.json) | Generators: ten frames, hundred charts, place-value charts | code | M3 | medium | true |
| [math-manip-code-008.json](tasks/math-manip-code-008.json) | Pattern blocks / geometric shapes (angle + edge accuracy) | code | M3 | medium | true |
| [math-manip-code-009.json](tasks/math-manip-code-009.json) | Internationalised numerals (>=1 additional numeral system) | code | M3 | medium | true |
| [math-manip-writing-003.json](tasks/math-manip-writing-003.json) | Teacher quick-start guides per manipulative family | writing | M3 | medium | false |
| [math-manip-maint-001.json](tasks/math-manip-maint-001.json) | Outcome dashboard + generator/font/toolchain maintenance | maintenance | M3 | medium | false |
| [math-manip-code-010.json](tasks/math-manip-code-010.json) | Algebra tiles / integer chips extension | code | Backlog | low | true |
| [math-manip-code-011.json](tasks/math-manip-code-011.json) | Clock faces / time manipulatives | code | Backlog | low | true |
| [math-manip-code-012.json](tasks/math-manip-code-012.json) | Money manipulatives (currency-neutral templates) | code | Backlog | low | true |
| [math-manip-writing-004.json](tasks/math-manip-writing-004.json) | Instructional-text translation (multilingual) | writing | Backlog | low | true |
| [math-manip-research-005.json](tasks/math-manip-research-005.json) | Cross-printer print-fidelity testing (more printer models) | research | Backlog | low | true |
| [math-manip-design-003.json](tasks/math-manip-design-003.json) | Tactile/braille-friendly manipulative variants (sibling project?) | design-spec | Backlog | low | true |
| [math-manip-code-013.json](tasks/math-manip-code-013.json) | Print-saver layouts (max pieces per sheet) per family | code | Backlog | low | true |

**Validation:** all 32 task JSONs pass the Elyos schema validator (`validateTask`). Exit 0.  
**Fan-out:** none applied — all tasks are enumerated directly from TASKS.md backlog rows (no dimensional fan-out dimensions were explicitly specified for this decomposition pass).  
**verifiedNeed policy:** `true` for infrastructure, tooling, research, and spec artifacts whose value is independent of a secured distribution channel; `false` for tasks that generate deliverable PDFs for distribution, distribution tasks, and beneficiary-validation tasks, consistent with the partner-gap honesty note in PLAN.md and the TASKS.md mapping rules.
